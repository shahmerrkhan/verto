...
export default function Footer() {
  ...
  const DISCORD_URL = 'https://discord.gg/7QeCydgv'
    ...
    <footer style={{
      ...
      <div style={{ maxWidth: '1140px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px', textAlign: 'center' }}>
        ...
        <a href={DISCORD_URL} target="_blank" rel="noopener noreferrer" style={{
          ...
          onMouseLeave={e => e.currentTarget.style.backgroundColor = 'rgba(88,101,242,0.1)'}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#7289da" xmlns="http://www.w3.org/2000/svg">
          ...
          Join Verto Community on Discord
        </a>
